<template>
  <svg class="label" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 76.45 76.45">
    <g id="label-0">
    ...
    <g id="label-9">
      ...
      <rect class="d d-" x="6.4816" y="12.96" width="5.18" height="5.18" transform="translate(18.13 31.09) rotate(-180)" style="fill: #3f3f3f"/>
    </g>
    <g id="label-10">
